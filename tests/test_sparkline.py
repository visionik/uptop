...
class TestValueToChar:
    ...
    def test_min_value_returns_lowest_char(self) -> None:
        """Test that minimum value returns lowest block character."""
    ...
    def test_same_min_max_returns_middle(self) -> None:
        ...
        assert char == SPARK_CHARS[3]  # Middle character (index 3 of 0-7 range)
...
class TestSparklineWidget:
    ...
    def test_render_full_width(self) -> None:
        ...
        assert rendered_str[0] == "▁"  # 0% is lowest block
    ...
    def test_render_min_values(self) -> None:
        ...
        rendered = sparkline.render()
        rendered_str = str(rendered)
        # All characters should be lowest block
        assert all(c == "▁" for c in rendered_str)
