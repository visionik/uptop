    ...
    def compose(self) -> ComposeResult:
        ...
        with Container():
            ...
            with Vertical(classes="help-section"):
                ...
                yield self._keybinding_row("Ctrl+P", "Command palette (switch plugins/layouts)")
                yield self._keybinding_row("l", "Cycle through layouts")
                yield self._keybinding_row("Alt+1-6", "Jump to layout preset")
                yield self._keybinding_row("m", "Cycle display mode for focused pane")
